...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const testimonials = [
    {
      rating: '⭐⭐⭐⭐⭐ 4/5',
      text: 'El servicio es increíble y el contacto con la empresa muy fluido, entienden muy bien mi negocio. SMI Networks se adapta con mucha rapidez a nuestras necesidades.',
